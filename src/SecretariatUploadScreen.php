...
<html lang="en">
<head>
    <title>Approved Resolution Upload Form</title>
      <link rel="stylesheet" type="text/css" href="css/EditorUploadScreenStyle.css"/>
</head>
<body>
    <h2>Approved Resolutions Upload Form</h2>
  
<div>
    <?php 
       echo "<form action='SecretariatProcessUpload.php?id=$usr_id' method='post' enctype='multipart/form-data' class='form'>";
    ?>
